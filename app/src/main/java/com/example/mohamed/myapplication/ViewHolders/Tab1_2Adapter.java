...
public class Tab1_2Adapter extends RecyclerView.Adapter<Tab1_2Adapter.ViewHolder> {
    ...
    public Tab1_2Adapter(Context context, ArrayList<second> listitem) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(context).inflate(R.layout.item_nested_tab1, null);
        return new Tab1_2Adapter.ViewHolder(v);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(context, Tab1_3.class);
